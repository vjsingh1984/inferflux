...
// supports continuous batching, priority scheduling, and per-request accounting.
struct InferenceRequest {
  ...
  int reported_prompt_tokens{-1};   // Prompt tokens counted once for metrics/logs.
  int total_completion_tokens{0};   // Completion tokens accumulated across slices.
  ...
  std::string accumulated_output;  // Aggregated completion text across fairness slices.
