...
struct Header {
  ...
  int64_t kv_count;     // Number of key-value pairs
};
...
public:
  ...
  static bool ReadInt64(FILE *file, int64_t *value);
  ...
  /**
   * @brief Skip a value from file based on type
   */
  static bool SkipValue(FILE *file, GGUF::ValueType type);
