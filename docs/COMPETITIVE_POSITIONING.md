...
|----------|-----------|------|--------|--------|-----------|
| NVIDIA CUDA | ✅ Native + Universal | ✅ | ✅ | ⚠️ Via llama.cpp | ⚠️ Via llama.cpp |
| AMD ROCm | ✅ Native + Universal | ❌ | ❌ | ❌ | ❌ |
| Apple MPS | ✅ Native + Universal | ❌ | ❌ | ⚠️ Via llama.cpp | ⚠️ Via llama.cpp |
...
flowchart TD
    ...
    M --> M[Rule 7: Unknown Format]
    N --> N[Rule 8: GPU Unused]
